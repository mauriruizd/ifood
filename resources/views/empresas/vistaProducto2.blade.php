...
@section('page-content')
    <div id="center">
        ...
        @else
            ...
            <form action="{{ URL::to('carrito/add') }}" method="POST" id="agregarCarrito">
                ...
                @if((count($filtrosPizza) > 0) || (count($agregados) > 0) || (count($sabores_extras) > 0))
                    <div id="categorias">
                        <div id="menu-filtros">
                            @if(count($filtrosPizza) > 0)
                                <a href="#" id="config-pizza" class="filtro"><span class="no-mobile">Configuraciones Pizza</span><span class="mobile-only"><i class="fa fa-cutlery"></i></span></a>
                            @endif
                            @if(count($agregados) > 0)
                                <a href="#" id="agregados" class="filtro"><span class="no-mobile">Agregados</span><span class="mobile-only"><i class="fa fa-building"></i></span></a>
                            @endif
                            @if(!is_null($sabores_extras))
                                <a href="#" id="mas_sabores" class="filtro" style="display: none;"><span class="no-mobile">Sabores Extras</span><span class="mobile-only"><i class="fa fa-star"></i></span></a>
                            @endif
                        </div>
                        <div id="filtros-activos">
                            @if(count($filtrosPizza) > 0)
                                <div id="filtro-pizzas" class="tab">
                                    <table>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td><b><i>Masa:</i></b></td>
                            ...
                            @endif
                            @if(count($agregados) > 0)
                                <div id="filtro-extras" class="tab">
                                    <table>
                                        <tr>
                                            <td>Extra</td>
                                            <td>Costo</td>
                            ...
                            @endif
                            @if(!is_null($sabores_extras))
                                <div id="filtro-sabores-extras-pizza" class="tab">
                                    <table>
                                        <tr>
                                            <td>Agregar</td>
                                            <td>Sabor</td>
    ...
    <script>
        ...
        $('.filtro:first').addClass('filtro-seleccionado');
